								...
								<table id="table"
										...
										<thead class="bg-primary">
											<tr>
												...
												<th class="text-center" style="width: 150px" >Fecha de Publicación</th>
												<th style="width: 600px">Contratación Administrativa de Servicio - CAS</th>
												<th class="text-center" >Cantidad</th>
												<th class="text-center" style="width: 120px">Bases</th>
												<th class="text-center" style="width: 120px">Evaluación Hoja de vida</th>
												<th class="text-center" style="width: 120px">Exámen técnico</th>
